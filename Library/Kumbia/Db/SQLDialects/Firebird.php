 ...
 *
 * Funciones de traductor de SQL para Firebird
 * Puede encontrar más información sobre MySQL en http://www.firebirdsql.com/.
 *
 * @category	Kumbia
 * @package		Db
 * @subpackage	SQLDialects
 * @copyright	Copyright (c) 2008-2010 Louder Technology COL. (http://www.loudertechnology.com)
 * @license		New BSD License
 * @link		http://www.php.net/manual/en/ref.pdo-firebird.php
 * @access		Public
 */
